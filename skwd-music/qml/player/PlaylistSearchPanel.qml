...
Item {
    ...
    Rectangle {
        ...
        ColumnLayout {
                    ...
                    TextInput {
                        ...
                        onAccepted: {
                            if (playlistList.currentIndex >= 0) {
                                ...
                                spotifyApi.searchPlaylistsByQuery(text.trim())
                            }
                        }
                    }
                }
            ...
            Text {
                text: {
                    let count = spotifyApi?.searchPlaylists?.length || 0
        ...
        Text {
            ...
            font.pixelSize: Root.Style.fontNormal
            color: Root.Colors.outline
            visible: spotifyApi?.playlistSearchLoading ?? false
        }
        ...
        ListView {
            ...
            model: spotifyApi?.searchPlaylists || []
            clip: true
            ...
            delegate: Item {
                ...
                opacity: 0
                transform: Translate { id: plEnterTranslate; y: -40 }
                ...
                SequentialAnimation {
                    ...
                    ParallelAnimation {
                        ...
                        NumberAnimation {
                            target: plEnterTranslate; property: "y"
